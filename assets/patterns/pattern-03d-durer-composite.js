...
var BASE = { pixelSize: 4, shape: 0, rippleThickness: 0.10 };
  ...
  function buildSolid(gl, U, canvas, getDpr) {
    ...
    function sync() {
      ...
      var dark = isDark();
      gl.uniform1f(U.uShapeLo, dark ? 0.02 : 1.15);
      gl.uniform1f(U.uShapeHi, dark ? 1.15 : 0.02);
      ok = true;
  ...
  function init(container, over) {
    ...
    ['uResolution','uTime','uColor','uShapeType','uPixelSize','uDensity','uFbmSpeed',
     ...
     'uShape','uShapeOrigin','uShapeSize','uShapeLo','uShapeHi','uAlpha','uShapeAlpha']
    ...
    function applyTheme() {
      ...
      gl.uniform1f(U.uAlpha, oa != null ? oa : t.alpha);
      /* The solid is the subject, not texture, so it sits well above the field. */
      gl.uniform1f(U.uShapeAlpha, isDark() ? 0.92 : 0.88);
      return t;
    }
