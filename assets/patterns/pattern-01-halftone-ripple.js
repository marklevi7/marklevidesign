/* mld-pattern-01 "Halftone Ripple" — dither dot field for the hero.
   Ported from the alumot-pattern handoff (preset: hero). The original ran on
...
(function () {
  ...
  var THEMES = {
    light: { ink: [0.13, 0.11, 0.15], density: 0.02, fbmSpeed: 0.05, rippleSpeed: 0.30, autoRippleMs: 5000, alpha: 0.55 },
    dark:  { ink: [1.00, 1.00, 1.00], density: 0.14, fbmSpeed: 0.09, rippleSpeed: 0.42, autoRippleMs: 3200, alpha: 0.85 }
  };
  var BASE = { pixelSize: 4, shape: 1, rippleThickness: 0.10, flowY: 0.0, gradientY: 0.0 };
  ...
  function init(container) {
    ...
    gl.uniform1f(U.uFlowY, BASE.flowY);
    gl.uniform1f(U.uGradientY, BASE.gradientY);
